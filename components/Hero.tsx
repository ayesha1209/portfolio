...
export default function Hero() {
  return (
    <section className="max-w-5xl mx-auto px-6 pt-14 pb-14">
      ...
      <h1 className="font-serif text-[2.2rem] sm:text-[clamp(2.8rem,7.5vw,5.5rem)] leading-[1.08] text-stone-900 mb-1">
        Hey, I&apos;m{" "}
        <span className="inline-flex items-end gap-2 leading-none">
          <span className="text-amber-500">Ayesha</span>
          <ProfilePhoto />
        </span>
      </h1>

      <p className="font-serif italic text-[2.2rem] sm:text-[clamp(2.8rem,7.5vw,5.5rem)] leading-[1.08] text-amber-500">
        I build the whole stack.
      </p>

      <p className="font-serif text-[clamp(0.95rem,2.6vw,1.75rem)] leading-[1.5] text-stone-900 mt-2 sm:whitespace-nowrap">
        Backends.{" "}
      ...
      <p className="font-serif text-[1.5rem] sm:text-[clamp(2rem,5.5vw,4rem)] leading-[1.12] text-stone-400 mt-1">
        From idea{" "}
